...
const experiences = [
  ...
  },
  {
    ...
    description:
      'Developed responsive web interfaces and cross-platform mobile application modules using modern React and React Native.',
    achievements: [
      'Implemented mobile application interfaces and reusable UI component libraries with React Native.',
      'Connected frontend applications with REST API services for smooth data synchronization.',
      'Ensured cross-platform consistency and responsive behavior across various screen sizes.',
    ],
    skills: ['React Native', 'React', 'TypeScript', 'JavaScript', 'CSS3'],
  },
  {
    type: 'education',
